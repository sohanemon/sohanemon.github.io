...
const Navbar = () => {
  ...
  return (
    <div
      className="flex font-[Gumela]   items-center h-[10vh] dark:text-slate-100 text-slate-600  py-6 
      mx-12"
    >
      <div className="flex flex-1 font-extrabold justify-center lg:justify-start text-2xl items-center">
        ...
        <IconContext.Provider value={{ className: `fill-orange-400  ` }}>
          <div
            ...
            className="cursor-pointer flex relative border-2 rounded-full p-1  mx-3 border-orange-400 overflow-hidden
            "
          >
            <IoSunnySharp />
            <MdNightlight />
