  ...
  return (
    ...
    >
      <motion.div
        ...
        viewport={{ once: true }}
        className=" rounded-full p-2 bg-gradient-to-r from-orange-500 to-sky-400 shadow-white"
      >
        <motion.div
          initial={{ rotate: 360 }}
          animate={{ rotate: 0 }}
          viewport={{ once: true }}
          transition={{ duration: 0.5, repeat: Infinity, ease: "linear" }}
          className="bg-white dark:bg-slate-900  rounded-full w-24 h-24 flex justify-center items-center"
        >
          <p className="font-bold ml-1 text-2xl text-slate-700 dark:text-slate-100">
            {num}
      ...
      <div className="text-center">
        <p className="text-slate-700 dark:text-slate-100 font-mono">{text1}</p>
